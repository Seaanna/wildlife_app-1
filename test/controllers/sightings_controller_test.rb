...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { animal_id: @sighting.animal_id, date: @sighting.date, latitude: @sighting.latitude, longitude: @sighting.longitude }
    end
  ...
  test "should update sighting" do
    patch :update, id: @sighting, sighting: { animal_id: @sighting.animal_id, date: @sighting.date, latitude: @sighting.latitude, longitude: @sighting.longitude }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
